...
struct cmd_spec cmd_table[] = {
    ...
    { "channel-attach",
      &main_channelattach, 1, 1,
      "Create a new virtual channel device",
      "<Domain> <channel-spec-component(s)>...",
    },
    { "channel-list",
    ...
    { "channel-detach",
      &main_channeldetach, 0, 1,
      "Destroy a domain's virtual channel device",
      "<Domain> <DevId>",
    },
    { "block-attach",
